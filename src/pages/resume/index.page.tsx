...
소믈리(주류정보서비스), 탐라(여행정보서비스), 샤벳(웹소설 서비스) 개발 및 운영`}
                ...
                <St mt={24} s2 text={`## 컨샐러드 2021.06(설립) ~ 현재`} />
                <St mt={8} s3>{`- Front-End Developer`}</St>
                ...
                <St
                  mt={24}
                  s2
                  text={`## 깔라만시 2020.07(설립) ~ 2021.06(M&A)`}
                />
                <St mt={8} s3>{`웹/모바일앱 개발 및 디자인 외주업체`}</St>
                ...
                <St mt={24} s2>{`## 와이콘즈 2019.01(설립) ~ 2021.03`}</St>
                <St
                  mt={8}
                  s3
                ...
                <St mt={24} s2>{`## 디프 2016.06(설립) ~ 2019.01`}</St>
                <St
                  mt={8}
                  s3
