        ...
        <Sv col pb={100}>
          ...
          <Sv mt={80} col>
            ...
            <St
              ...
              g0
              b1
              text={`작년 2021년 6월 개발자로 전직해 1년간 프론트엔드 개발을 하였습니다. 그 이전엔 3년간의 그래픽 디자인 에이전시 운영 경험, 2년간의 UI/UX 설계 및 디자인 경험, 1년 간의 스타트업 운영 경험을 가지고 있습니다. 한명의 공동창업자와 스타트업을 시작해서 총 인원 9명 규모까지 확장하고, 작지만 M&A까지 이끌어나간 경험이 있습니다.
...
소믈리(주류정보서비스), 탐라(여행정보서비스), 샤벳(웹소설 서비스) 개발 및 운영`}
                ...
                <St>{`- PM(Product Manager)`}</St>
                <St>{` - 노션, 지라를 도입해 효율적인 협업, 커뮤니케이션, 업무 프로세스를 정립`}</St>
                <St>{`## 와이콘즈 2019.01(설립) ~ 2021.03`}</St>
                <St>{`연세대학교 학식 예약 및 결제 서비스 “Yammi”`}</St>
                <St>{`- UI/UX Designer`}</St>
                ...
                <St>{`## 디프 2016.06(설립) ~ 2019.01`}</St>
                <St>{`BX Design 및 기타 디자인 프로젝트를 진행하는 디자인 스튜디오`}</St>
                <St>{`- BX Designer`}</St>
